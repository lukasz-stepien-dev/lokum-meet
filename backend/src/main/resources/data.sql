...
INSERT INTO users (username, email, birth_date, age, avatar_url, bio, is_verified, banned, created_at, updated_at)
VALUES ('admin', 'admin@lokummeet.pl', '1990-01-01', 34,
        'https://ui-avatars.com/api/?name=Admin&background=random', 'Administrator systemu', true, false, NOW(), NOW());

INSERT INTO users (username, email, birth_date, age, avatar_url, bio, is_verified, banned, created_at, updated_at)
VALUES
('anna_kowalska', 'anna.kowalska@example.com', '1998-05-15', 26,
...
('jan_nowak', 'jan.nowak@example.com', '2000-03-22', 24,
...
('maria_wisniewski', 'maria.wisniewski@example.com', '1995-11-08', 29,
...
('piotr_lewandowski', 'piotr.lewandowski@example.com', '1992-07-30', 32,
...
('kasia_dabrowska', 'kasia.dabrowska@example.com', '2001-09-12', 23,
...
-- Replace these lines in data.sql:
INSERT INTO user_roles (user_id, user_roles) VALUES (1, 'ROLE_ADMIN');
INSERT INTO user_roles (user_id, user_roles) VALUES (1, 'ROLE_USER');

INSERT INTO user_roles (user_id, user_roles) VALUES (2, 'ROLE_USER');
INSERT INTO user_roles (user_id, user_roles) VALUES (3, 'ROLE_USER');
INSERT INTO user_roles (user_id, user_roles) VALUES (4, 'ROLE_USER');
INSERT INTO user_roles (user_id, user_roles) VALUES (5, 'ROLE_USER');
INSERT INTO user_roles (user_id, user_roles) VALUES (6, 'ROLE_USER');
...
VALUES
('Klub Filmowy Muza', 'kontakt@klubmuza.pl', 'CULTURAL_CENTER',
 'Miejsce dla miłośników dobrego kina. Organizujemy seanse filmów artystycznych i dyskusje.',
 'APPROVED', 1, NOW(), 'https://ui-avatars.com/api/?name=Klub+Muza&background=random',
 'https://klubmuza.pl', NOW(), NOW()),

('Akademia Sportu', 'info@akademiasportu.pl', 'SPORTS_CLUB',
 'Zajęcia sportowe dla każdego. Od jogi po crossfit!',
 'APPROVED', 1, NOW(), 'https://ui-avatars.com/api/?name=Akademia+Sportu&background=random',
 'https://akademiasportu.pl', NOW(), NOW()),

('Dom Kultury Centrum', 'biuro@dkcentrum.pl', 'CULTURAL_CENTER',
 'Organizujemy warsztaty, koncerty i wystawy. Serce kulturalne miasta!',
 'APPROVED', 1, NOW(), 'https://ui-avatars.com/api/?name=DK+Centrum&background=random',
